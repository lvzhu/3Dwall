...
// 图片列表
var PICLIST = ['./img/12.jpg', './img/1.jpg', './img/5.jpg', './img/3.jpg', './img/4.jpg', './img/5.jpg', './img/6.jpg'
  , './img/closebtn.png', './img/12.jpg', './img/1.jpg', './img/5.jpg', './img/3.jpg', './img/4.jpg', './img/5.jpg', './img/6.jpg'
  , './img/closebtn.png', './img/12.jpg', './img/1.jpg', './img/5.jpg', './img/3.jpg', './img/4.jpg', './img/5.jpg', './img/6.jpg'
  , './img/closebtn.png', './img/12.jpg', './img/1.jpg', './img/5.jpg', './img/3.jpg', './img/4.jpg', './img/5.jpg', './img/6.jpg'
  , './img/closebtn.png', './img/12.jpg', './img/1.jpg', './img/5.jpg', './img/3.jpg', './img/4.jpg', './img/5.jpg', './img/6.jpg'
  , './img/closebtn.png', './img/12.jpg', './img/1.jpg', './img/5.jpg', './img/3.jpg', './img/4.jpg', './img/5.jpg', './img/6.jpg'
...
function init() {
  ...
  setInterval(function(){
    if(count==2){
      var buy = document.getElementById('cylinder_button');
      count=0;
    }else{
      switch(count){
        case 0:
            var buy = document.getElementById('house_button');
            count++;
            break;
        case 1:
            var buy = document.getElementById('wall_button');
            count++;
            break;
        case 2:
            var buy = document.getElementById('cylinder_button');
